...
<head>
    ...
    <!--=== Favicon ===-->
    <link rel="shortcut icon" href="<?= ASSETS_PATH ?>img/favicon.ico" type="image/x-icon" />
...
<body>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="logo">
                            <a href="index.html">
                                <img src="<?= ASSETS_PATH ?>img/logo/logo.png" alt="Brand Logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-9">
                            ...
                            <div class="col-12">
                                <div class="content-inner">
                                    ...
                                    <div class="slider-img">
                                        <img src="<?= ASSETS_PATH ?>img/slider/slide_2.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="category-item-inner color1 text-center">
                                ...
                                <div class="category-thumb">
                                    <a href="product-details.html">
                                        <img src="<?= ASSETS_PATH ?>img/category/cat-1.png" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-5 col-md-6">
                                <div class="product-large-slider mb-20 slider-arrow-style slider-arrow-style__style-2">
                                    <div class="pro-large-img">
                                        <img src="<?= ASSETS_PATH ?>img/product/product-details-img1.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="<?= ASSETS_PATH ?>img/product/product-details-img2.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="<?= ASSETS_PATH ?>img/product/product-details-img3.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="<?= ASSETS_PATH ?>img/product/product-details-img4.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="pro-nav slick-padding_2 slider-arrow-style slider-arrow-style__style-2">
                                    <div class="pro-nav-thumb"><img src="<?= ASSETS_PATH ?>img/product/product-details-img1.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="<?= ASSETS_PATH ?>img/product/product-details-img2.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="<?= ASSETS_PATH ?>img/product/product-details-img3.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="<?= ASSETS_PATH ?>img/product/product-details-img4.jpg"
                                            alt="" /></div>
                                </div>
                            </div>
                                ...
                                <div class="product-details-des">
                                    <div class="product-content-list">
                                        ...
                                        <div class="action-link mb-20">
                                            <a href="#" data-bs-toggle="tooltip" title="Add to cart" class="add-to-cart">add
                                                to cart</a>
                                            <a href="#" data-bs-toggle="tooltip" title="Wishlist"><i class="ion-android-favorite-outline"></i></a>
                                            <a href="#" data-bs-toggle="tooltip" title="Compare"><i class="ion-ios-shuffle"></i></a>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="payment-method text-md-end text-center">
                            <img src="<?= ASSETS_PATH ?>img/payment.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--=======================Javascript============================-->
    <!--=== All Vendor Js ===-->
    <script src="<?= ASSETS_PATH ?>js/vendor.js"></script>
    <!--=== All Plugins Js ===-->
    <script src="<?= ASSETS_PATH ?>js/plugins.js"></script>
    <!--=== Active Js ===-->
    <script src="<?= ASSETS_PATH ?>js/active.js"></script>
</body>


<!-- Mirrored from htmldemo.net/selena/selena/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 May 2023 10:14:41 GMT -->
</html>