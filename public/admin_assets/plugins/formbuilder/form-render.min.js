    ...
    ! function (e) {
        ...
        class a {
            constructor(e, t) {
                ...
                this.classConfig = jQuery.extend({}, a.controlConfig[r] || {}), this.subtype && (e.type = this.subtype), this.required && this.required=='true' && (e.required = "required", e["aria-required"] = "true"), this.disabled && this.disabled=='true' && (e.disabled = "disabled"), this.config = e, this.configure()
            }
        ...
        class i {
            ...
            label() {
                const e = this.data.label || "",
                    t = [r.g.parsedHtml(e)];
                return this.data.required && this.data.required=='true' && t.push(this.markup("span", "*", {
        ...
        class m extends o.a {
            ...
            build() {
                const e = [],
                    ...
                    u = i.replace("-group", ""),
                    p = "select" === i;
                if (((c.multiple && c.multiple=='true') || "checkbox-group" === i) && (c.name = c.name + "[]"), "checkbox-group" === i && c.required) {
                    const e = this,
        ...
        class g extends o.a {
            ...
            build() {
                ...
                e = this.config.multiple && this.config.multiple=='true' ? e + "[]" : e;
                const t = Object.assign({}, this.config, {
                    name: e
                });
        ...
        class w extends v {
            ...
            build() {
                const e = this.config,
                    ...
                    n = x(e, ["value"]);
                return delete n.type, this.field = this.markup("textarea", this.parsedHtml(t), n), n.disabled && n.disabled=='true' && (this.editorOptions.readonly = !0), this.field
            }
            onRender(e) {
